...
## Christian Dutary — QA / Documentación (~330 palabras)

Hola, soy Christian Dutary, responsable de QA, testing y documentación del sistema DDC-SSNF.
...
Los aprendizajes más valiosos fueron la importancia del testing automatizado desde el inicio del proyecto y cómo las métricas de calidad guían decisiones técnicas informadas.
...
## Jose Avila — Backend / API (~330 palabras)

Hola, soy Jose Avila, responsable del backend y la API del sistema DDC-SSNF.
...
En el Sprint 4, colaboré con Christian en la configuración de SonarCloud y la resolución de code smells detectados. Optimicé las consultas Prisma para mejorar el rendimiento de las consultas N+1 que habíamos identificado.
